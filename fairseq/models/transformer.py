...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def __init__(self, args, encoder, decoder, lm_decoder=None):
    ...
    def build_model(cls, args, task):
        ...
        if args.add_language_model:
            if args.share_transformer_lm_decoder_embed:
                ...
                nn.init.normal_(lm_decoder_softmax_weight.weight, mean=0, std=args.decoder_embed_dim**-0.5)
